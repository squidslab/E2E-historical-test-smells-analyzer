...
INPUT_CSV = os.path.join("e2e-test-smell-analyzer-main", "javascript_analysis.csv")

# SQLite output
DB_PATH = "historical_smellsJS.db"
...
from detectors.javascript.absolute_url_detector import AbsoluteUrlDetectorJS
from detectors.javascript.absolute_xpath_detector import AbsoluteXPathDetectorJS
from detectors.javascript.assertion_roulette_detector import AssertionRouletteDetectorJS
from detectors.javascript.complex_test_detector import ComplexTestDetectorJS
from detectors.javascript.conditional_logic_detector import ConditionalLogicDetectorJS
from detectors.javascript.constructor_initialization_detector import ConstructorInitializationDetectorJS
from detectors.javascript.duplicate_assert_detector import DuplicateAssertDetectorJS
from detectors.javascript.empty_test_detector import EmptyTestDetectorJS
from detectors.javascript.exception_handling_detector import ExceptionHandlingDetectorJS
from detectors.javascript.magic_number_detector import MagicNumberDetectorJS
from detectors.javascript.misused_tag_locator_detector import MisusedTagLocatorDetectorJS
from detectors.javascript.preferred_locator_detector import PreferredLocatorDetectorJS
from detectors.javascript.redundant_print_detector import RedundantPrintDetectorJS
from detectors.javascript.sleepy_test_detector import SleepyTestDetectorJS
from detectors.javascript.redundant_assertion_detector import RedundantAssertionDetectorJS
from detectors.javascript.sensitive_equality_detector import SensitiveEqualityDetectorJS
from detectors.javascript.unknown_test_detector import UnknownTestDetectorJS
from detectors.javascript.unstable_link_text_detector import UnstableLinkTextDetectorJS

# ========= DETECTORS =========
detectors = [
    AbsoluteUrlDetectorJS,
    AbsoluteXPathDetectorJS,
    AssertionRouletteDetectorJS,
    ComplexTestDetectorJS,
    ConditionalLogicDetectorJS,
    ConstructorInitializationDetectorJS,
    DuplicateAssertDetectorJS,
    EmptyTestDetectorJS,
    ExceptionHandlingDetectorJS,
    MagicNumberDetectorJS,
    MisusedTagLocatorDetectorJS,
    PreferredLocatorDetectorJS,
    RedundantPrintDetectorJS,
    SleepyTestDetectorJS,
    RedundantAssertionDetectorJS,
    SensitiveEqualityDetectorJS,
    UnknownTestDetectorJS,
    UnstableLinkTextDetectorJS
]
...
def _extract_smell_rows(commit, repo_name: str, targets: list[dict], by_basename: dict[str, list[int]], ts_parser: JavaScriptParser, release_index):
